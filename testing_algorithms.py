...
img = pd.read_csv('datatest/A1 97_ac.csv')
x = np.loadtxt('datatest/A1 97_ac_x.txt')
y = np.loadtxt('datatest/A1 97_ac_y.txt')
...
fig, (ax, ax2, ax3, ax4, ax5, ax6) = plt.subplots(nrows=1, ncols=6, figsize=(12, 8),
